...
CUDA_VERSION="12.2.2"
CUDA_FULL_VERSION="${CUDA_VERSION}_535.104.05"
...
# Reservar menos espaço para o root
sudo tune2fs -m 1 /dev/nvme0n1p1

# instala CUDA (from https://developer.nvidia.com/cuda-downloads)
cd /mnt/ephemeral
...
sudo -u admin wget --no-verbose https://huggingface.co/runwayml/stable-diffusion-v1-5/resolve/main/v1-5-pruned.safetensors
sudo -u admin wget --no-verbose https://huggingface.co/stabilityai/stable-diffusion-2-1-base/resolve/main/v2-1_512-ema-pruned.safetensors
sudo -u admin wget --no-verbose https://huggingface.co/stabilityai/stable-diffusion-2-1/resolve/main/v2-1_768-ema-pruned.safetensors
sudo -u admin wget --no-verbose https://huggingface.co/stabilityai/stable-diffusion-xl-base-1.0/resolve/main/sd_xl_base_1.0.safetensors -O sd_xl_base_1.0.safetensors
sudo -u admin wget --no-verbose https://huggingface.co/stabilityai/stable-diffusion-xl-refiner-1.0/resolve/main/sd_xl_refiner_1.0.safetensors -O sd_xl_refiner_1.0.safetensors
